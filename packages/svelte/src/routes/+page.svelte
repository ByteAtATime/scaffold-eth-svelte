...
<div class="flex flex-grow flex-col items-center pt-10">
	<div class="px-5">
		...
		<p class="text-center text-lg">
			...
			<code
				class="inline-block max-w-full break-words break-all bg-base-300 text-base font-bold italic"
			>
	...
	<div class="mt-16 w-full flex-grow bg-base-300 px-8 py-12">
		<div class="flex flex-col items-center justify-center gap-12 sm:flex-row">
			<div
				class="flex max-w-xs flex-col items-center rounded-3xl bg-base-100 px-10 py-10 text-center"
			>
